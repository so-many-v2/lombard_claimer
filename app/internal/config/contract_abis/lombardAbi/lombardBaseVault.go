...
var BASE_VAULT_ABI = `[
   ...
   },
   {
      ...
      "name":"AtomicQueue__SafeRequestAccountantOfferMismatch",
      "type":"error"
   },
   {
      "inputs":[
      ...
      "name":"AtomicQueue__SafeRequestCannotCastToUint88",
      "type":"error"
   },
   {
      "inputs":[
      ...
      "name":"AtomicQueue__SafeRequestDeadlineExceeded",
      "type":"error"
   },
   {
      "inputs":[
      ...
      "name":"AtomicQueue__SafeRequestDiscountTooLarge",
      "type":"error"
   },
   {
      "inputs":[
      ...
      "name":"AtomicQueue__SafeRequestInsufficientOfferAllowance",
      "type":"error"
   },
   {
      "inputs":[
      ...
      "name":"AtomicQueue__SafeRequestOfferAmountGreaterThanOfferBalance",
      "type":"error"
   },
   {
      "inputs":[
      ...
      "name":"AtomicQueue__SafeRequestOfferAmountZero",
      "type":"error"
   },
   {
      "inputs":[
   ...
   },
   {
      ...
      "outputs":[
         ...
         {
            "internalType":"uint256",
            "name":"totalAssetsForWant",
            "type":"uint256"
         },
         {
            "internalType":"uint256",
            "name":"totalAssetsToOffer",
            "type":"uint256"
         }
      ],
      "stateMutability":"view",
      ...
      "outputs":[
         {
            "components":[
               ...
               {
                  "internalType":"bool",
                  "name":"insufficientOfferAllowance",
                  "type":"bool"
               },
               {
                  "internalType":"uint256",
            ...
            "internalType":"struct AtomicQueue.VerboseSolveMetaData[]",
            "name":"metaData",
            "type":"tuple[]"
         },
         {
